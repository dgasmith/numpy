...
def einsum(subscripts, *operands, **kwargs):
    print subscripts, operands, kwargs
    """
    ...
    *operands : list of array_like
    ...
    if (indices == output_set) and not return_path_arg:
        return c_einsum(subscripts, *operands, **einsum_args)
    ...
    for inds, gemm, einsum_str, remaining in contraction_list:
        ...
        # Do the contraction
        new_view = c_einsum(einsum_str, *tmp_operands, **einsum_args)
